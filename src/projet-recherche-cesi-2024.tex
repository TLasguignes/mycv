...
\usepackage[citestyle=numeric,mincitenames=1,maxcitenames=1,bibstyle=ieee,backend=bibtex8,dashed=false]{biblatex}
...
% Pour éviter le "---" en cas de citation suivie d'articles des mêmes auteurs
\AtEveryCitekey{\ifciteseen{}{\defcounter{maxnames}{99}}}
\AtEveryBibitem{\ifentryseen{}{\defcounter{maxnames}{99}}}
...
%     \item[\done] 1 ou 2 chercheurs identifiés au sein de CESI-LINEACT avec lesquels vous pourriez collaborer et comparer quelques publications (1 à 2) de ces chercheurs avec le projet proposé.
